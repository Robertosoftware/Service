...
$nombre="";
 $nombre = mysqli_real_escape_string($db, $_POST['nombre']);
    $query = "Insert into zona (nombre) values ('$nombre')";
  	$results = mysqli_query($db, $query);
        if($results){
      	  header('location: ../../index.php#!/Zona');}
    else{
                echo "ERROR";
    }
}
...
if (isset($_GET['ezona'])) {
  	  ...
  	  $_SESSION['id'] = $edit;
        header('location: ../../index.php#!/Zona-editar');
}
...
if (isset($_GET['ecategoria'])) {
  	  ...
  	  $_SESSION['id'] = $edit;
        header('location: ../../index.php#!/Categoria-editar');
}
 ...
 $nombre = mysqli_real_escape_string($db, $_POST['nombre']);
  $descripcion = mysqli_real_escape_string($db, $_POST['descripcion']);
    $query = "Insert into materia (nombre, descripcion) values ('$nombre','$descripcion')";
  	$results = mysqli_query($db, $query);
        if($results){
      	  header('location: ../../index.php#!/Materia');}
    else{
                echo "ERROR";
    }
}
if (isset($_GET['emateria'])) {
  	  ...
  	  $_SESSION['id'] = $edit;
        header('location: ../../index.php#!/Materia-editar');
}
