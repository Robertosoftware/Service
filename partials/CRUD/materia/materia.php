        ...
        if($result)
        {
            while($row=mysqli_fetch_array($result)){
                ...
                <td>'.$row['descripcion'].'</td>
                 <td><a href="partials/CRUD/server-crud.php?emateria='.$row['idmateria'].'" class="btn btn-info">Editar</a></td>
                    <td><a href="partials/CRUD/server-crud.php?dmateria='.$row['idmateria'].'" class="btn btn-danger">Eliminar</a></td>
                    </tr>
                ';
            }
        }
